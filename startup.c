...
extern unsigned long  _eusrstack;
...
(intfunc)((unsigned long)&_eusrstack), /* The stack pointer after relocation */
...
TAMPER_STAMP_IRQHandler, /* Tamper */
...
DMA2_Channel4_5_IRQHandler,//DMA2 Channel4 and  Channel5 global interrupt 
